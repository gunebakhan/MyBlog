...
from .api import post_list, comment_list, comment_detail, post_detail, PostList, PostDetail, PostListMixins, PostDetailMixin
...
urlpatterns = [
    ...
    path('api/posts/', PostListMixins.as_view(), name="post_list"),
